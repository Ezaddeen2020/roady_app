...
abstract class SavedDestinationRepository {
  ...
  Future<Either<Failure, void>> remove(int destinationId);
  Future<Either<Failure, List<SavedDestinationModel>>> fetchSaved();
  Future<Either<Failure, bool>> isSaved(int destinationId);
}
...
class SavedDestinationRepositoryImpl implements SavedDestinationRepository {
  ...
  @override
  Future<Either<Failure, void>> remove(int destinationId) async {
    try {
  ...
  @override
  Future<Either<Failure, bool>> isSaved(int destinationId) async {
    try {
