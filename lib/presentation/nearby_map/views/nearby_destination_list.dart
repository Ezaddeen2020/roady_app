import 'package:fdelux_source_neytrip/common/widgets/custom_failed_section.dart';
...
import 'package:fdelux_source_neytrip/presentation/nearby_map/views/nearby_destination_item.dart';
...
class NearbyDestinationList extends StatelessWidget {
  static final _itemKeys = <int, GlobalKey>{};
          ...
          if (list.isNotEmpty) {
            return ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                if (!_itemKeys.containsKey(destination.id)) {
                  _itemKeys[destination.id] = GlobalKey();
                }
                return NearbyDestinationItem(
                  key: _itemKeys[destination.id],
